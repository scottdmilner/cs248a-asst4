...
from cs248a_renderer.model.material import FilteringMethod, MaterialField, BRDFType
...
class SceneEditorWindow(Window):
    ...
    def _render_material(self, mesh: Mesh, name: str = "") -> None:
        ...
        brdf_types = ["LAMBERTIAN", "MIRROR", "GLASS", "RETROREFLECTIVE", "RETROREFLECTIVE_LAMBERTIAN"]
        ...
        # Render IOR slider for glass materials
